...
OUT_PATH_TEMPLATE = "./output/refactoring_distribution_count_{ts}.pdf"
...
if __name__ == "__main__":
    ...
    # Step 1: Calculate absolute counts
    all_counts = {}
    ...
    for lang, df_lang in df.groupby("Lang"):
        ...
        if "RefactoringType" in df_lang.columns:
            ...
            # Calculate absolute counts for the filtered DataFrame
            counts = filtered_df["RefactoringType"].value_counts()
    ...
    for container in ax.containers:
        ...
        if refactoring_type in plot_data.index:
            ...
            display_labels = [f"{int(v)}" if v > 0 else "" for v in labels]
